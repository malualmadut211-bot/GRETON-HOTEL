...
export function OfficeHours() {
  ...
  return (
    <section className="max-w-[1000px] mx-auto px-5 my-[80px] grid grid-cols-1 md:grid-cols-3 gap-[30px]">
      <motion.div
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="bg-white p-[40px_30px] rounded-[16px] text-center shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all duration-400 group overflow-hidden relative hover:-translate-y-[10px] hover:shadow-[0_8px_35px_rgba(212,175,55,0.2)]"
      >
        ...
        <div className="w-[80px] h-[80px] mx-auto mb-5 relative group-hover:scale-110 transition-transform duration-500">
           <div className="w-full h-full border-[4px] border-gold rounded-full relative bg-white shadow-[inset_0_0_20px_rgba(212,175,55,0.1),0_4px_15px_rgba(0,0,0,0.1)]">
        ...
        <h4 className="text-[20px] text-[#2C2C2C] mb-[10px] font-bold group-hover:text-gold transition-colors">Reception Hours</h4>
        <p className="text-[24px] font-bold text-gold mb-2 group-hover:animate-[timePulse_2s_ease_infinite]">24 Hours / 7 Days</p>
        <span className="text-[14px] text-[#999] italic">Always here to serve you</span>
      </motion.div>
      ...
      >
        ...
        <h4 className="text-[20px] text-[#2C2C2C] mb-[10px] font-bold group-hover:text-gold transition-colors">Email Response</h4>
        <p className="text-[24px] font-bold text-gold mb-2 group-hover:animate-[timePulse_2s_ease_infinite]">Within 24 Hours</p>
        <span className="text-[14px] text-[#999] italic">Usually much faster</span>
      </motion.div>
      ...
      >
        ...
        <h4 className="text-[20px] text-[#2C2C2C] mb-[10px] font-bold group-hover:text-gold transition-colors">Phone Availability</h4>
        <p className="text-[24px] font-bold text-gold mb-2 group-hover:animate-[timePulse_2s_ease_infinite]">24/7 Support</p>
        <span className="text-[14px] text-[#999] italic">Instant assistance anytime</span>
      </motion.div>
    </section>
  );
}
